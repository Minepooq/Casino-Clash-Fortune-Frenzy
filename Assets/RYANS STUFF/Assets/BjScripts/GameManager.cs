...
public class GameManager : MonoBehaviour
{
    ...
    void Update()
    {
        coins = coincounter.CurrentCoins;
       ...
       if(dealerScript.GetHandVal() > 16){
            if(dVal< 22 && dVal>pVal && pVal <22){
                ...
                coincounter.CurrentCoins += betVal * 2;
                addedToBalance = true;
                canReset = true;
            }else if(dVal == pVal && !addedToBalance){
                text.text = "Push!";
                coincounter.CurrentCoins += betVal;
                addedToBalance = true;
                canReset = true;
            }
       } 
       ...
       Balance.text = "coins: " + coincounter.CurrentCoins;

    }

    public void backbutton()
    {
        SceneManager.LoadSceneAsync("CASINO ENTRANCE");
